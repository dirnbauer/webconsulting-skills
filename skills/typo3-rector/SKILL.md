...
name: typo3-rector
description: >-
  TYPO3 v14 upgrade patterns using Rector: automated refactoring rules, level sets, and
  migration workflows. Use when working with rector, upgrade, migration, refactoring,
  deprecation.
