...
# install.sh.
#
# Local skills, including typo3-webcomponents and typo3-14-update, are not listed
# one-by-one here. They are picked up from skills/*/SKILL.md when update.sh
# delegates catalog, manifest, and installation refreshes to install.sh.
#
